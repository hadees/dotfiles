...
```bash
cd; curl -#L https://github.com/hadees/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,LICENSE-MIT.txt}
```
...
* [Mathias Bynens](https://mathiasbynens.be/) because this was forked from his [dotfiles repository](https://github.com/mathiasbynens/dotfiles).
