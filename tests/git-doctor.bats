...
@test "doctors: every reachable helper is covered by the defined: line" {
  ...
  run zsh -c '
    ...
    typeset -A wrapped=(claude claude worktabs "" attend "" postbox "" workset workset wrangler wrangler gh gh hermes hermes tailnet "ssh scp sftp curl tailnet-as" git "" onepassword "" iterm2 "")
    local d h n=0 bad=0
    for d in claude worktabs attend postbox workset wrangler gh hermes tailnet git onepassword iterm2; do
